...
public class CommandCubePos1 extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (sender.getCommandSenderEntity() instanceof EntityPlayer) {
            ...
            try {
                positions.setKey(new Vector3i(MathUtil.parseInt(args[0]), MathUtil.parseInt(args[1]), MathUtil.parseInt(args[2])));
                ...
                sender.sendMessage(TextComponentHelper.createComponentTranslation(sender, "mawm.command.cubepos1.invalid_args"));
            }
        }
    }
}
